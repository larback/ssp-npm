...
int main(int argc, char *argv[])
{
	...
	// // DEBUG Confere instância
	// // Tempo de processamento em cada máquina
	// cout << "n: " << n << endl << "t: " << t << endl << "m: " << m << endl;
	// cout << "Tempo de processamento dos jobs" <<endl;
	// for (unsigned j=0; j< m; j++)
	// {
	// 	std::vector<unsigned> mProcessamento;
	// 	for (unsigned i = 0; i < n; ++i)
	// 	{
	// 		cout << tProcessamento[j][i] << ' ';
	// 	}
	// 	cout << endl;
	// }

	// cout << "Magazine das máquinas "<<endl;
	// for (int i=0;i<m;++i)
	// 	cout << c[i] << ' ';
	// cout << endl;
	// cout << "Tempo de troca de cada máquina" << endl;
	// for (int i=0;i<m;i++)
	// 	cout << tempoTroca[i] << ' ';
	// cout << endl;


	// // DEBUG FerramentasJOB
	// cout << "Ferramentas por JOB" << endl;
	// for (int i=0;i<n;i++)
	// 	cout << ferramentasJob[i] << ' ';
	// cout << endl << endl;

	// cout << "Matriz de ferramentas" << endl;
	// for (unsigned j = 0; j < t; j++)
	// {
	// 	for (unsigned i = 0; i < n; ++i)
	// 	{
